...
class Form extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('optID', Type\ChoiceType::class, ['required' => false, 'label' => 'Оптовый пакет', 'choices' => array_flip($this->optFetcher->assoc()), 'help' => 'Если указан, то все цены склада будут от этого оптового пакета'])
