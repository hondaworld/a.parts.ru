...
class Form extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('catalogs', Type\TextareaType::class, ['required' => false, 'label' => 'Каталоги'])
            ->add('alt_names', Type\TextareaType::class, ['required' => false, 'label' => 'Альтернативные наименования'])
        ;
    }
