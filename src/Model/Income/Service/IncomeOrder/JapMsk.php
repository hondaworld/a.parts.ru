...
class JapMsk extends ExcelPrice implements IncomeOrderExcelImpl
{
    public function create(): string
    {
        ...
        $filename = "order #" . $document_num . " - " . $this->incomeOrder->getDateofadded()->format('d.m.Y') . " (Москва).xls";
        ...
        $aSheet->setCellValue("A2", "Заказ №" . $document_num . " - " . $this->incomeOrder->getDateofadded()->format('d.m.Y') . " (Москва)");
