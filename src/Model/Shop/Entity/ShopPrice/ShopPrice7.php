...
/**
 * @ORM\Entity(repositoryClass=ShopPrice7Repository::class)
...
class ShopPrice7
{
     ...
     * @ORM\Id
     * @var Creater
     * @ORM\ManyToOne(targetEntity="App\Model\Detail\Entity\Creater\Creater", inversedBy="shopPrice7")
     ...
     * @ORM\Id
     * @var ProviderPrice
     * @ORM\ManyToOne(targetEntity="App\Model\Provider\Entity\Price\ProviderPrice", inversedBy="shopPrice7")
