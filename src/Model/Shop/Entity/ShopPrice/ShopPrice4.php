...
/**
 * @ORM\Entity(repositoryClass=ShopPrice4Repository::class)
...
class ShopPrice4
{
     ...
     * @ORM\Id
     * @var Creater
     * @ORM\ManyToOne(targetEntity="App\Model\Detail\Entity\Creater\Creater", inversedBy="shopPrice4")
     ...
     * @ORM\Id
     * @var ProviderPrice
     * @ORM\ManyToOne(targetEntity="App\Model\Provider\Entity\Price\ProviderPrice", inversedBy="shopPrice4")
