...
/**
 * @ORM\Entity(repositoryClass=ShopPrice5Repository::class)
...
class ShopPrice5
{
     ...
     * @ORM\Id
     * @var Creater
     * @ORM\ManyToOne(targetEntity="App\Model\Detail\Entity\Creater\Creater", inversedBy="shopPrice5")
     ...
     * @ORM\Id
     * @var ProviderPrice
     * @ORM\ManyToOne(targetEntity="App\Model\Provider\Entity\Price\ProviderPrice", inversedBy="shopPrice5")
