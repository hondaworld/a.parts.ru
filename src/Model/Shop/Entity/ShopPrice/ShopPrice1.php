...
/**
 * @ORM\Entity(repositoryClass=ShopPrice1Repository::class)
...
class ShopPrice1
{
     ...
     * @ORM\Id
     * @var Creater
     * @ORM\ManyToOne(targetEntity="App\Model\Detail\Entity\Creater\Creater", inversedBy="shopPrice1")
     ...
     * @ORM\Id
     * @var ProviderPrice
     * @ORM\ManyToOne(targetEntity="App\Model\Provider\Entity\Price\ProviderPrice", inversedBy="shopPrice1")
