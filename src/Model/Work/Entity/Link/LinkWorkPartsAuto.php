...
/**
 * @ORM\Entity(repositoryClass=LinkWorkPartsAutoRepository::class)
 * @ORM\Table(name="linkWorkPartsAuto")
 */
class LinkWorkPartsAuto
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @var WorkGroup
     * @ORM\ManyToOne(targetEntity="App\Model\Work\Entity\Group\WorkGroup", inversedBy="autos_parts", fetch="EAGER")
    ...
    /**
     * @var AutoMarka
     * @ORM\ManyToOne(targetEntity="App\Model\Auto\Entity\Marka\AutoMarka", inversedBy="work_autos_parts", fetch="EAGER")
    ...
    /**
     * @var AutoModel
     * @ORM\ManyToOne(targetEntity="App\Model\Auto\Entity\Model\AutoModel", inversedBy="work_autos_parts", fetch="EAGER")
    ...
    /**
     * @var AutoGeneration
     * @ORM\ManyToOne(targetEntity="App\Model\Auto\Entity\Generation\AutoGeneration", inversedBy="work_autos_parts", fetch="EAGER")
     ...
     * @ORM\ManyToOne(targetEntity="App\Model\Auto\Entity\Modification\AutoModification", inversedBy="work_autos_parts", fetch="EAGER")
    ...
    public function __construct(WorkGroup $workGroup, ?AutoMarka $autoMarka, ?AutoModel $autoModel, ?AutoGeneration $autoGeneration, ?AutoModification $autoModification, string $parts)
    {
