...
class CreatePriceSummaryOpt4Command extends Command
{
    protected static $defaultName = 'app:create-price-summary-opt4';
    protected static $defaultDescription = 'Создание excel прайс-листа склейки ОПТ4';
