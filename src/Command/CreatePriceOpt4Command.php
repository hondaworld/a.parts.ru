...
class CreatePriceOpt4Command extends Command
{
    protected static $defaultName = 'app:create-price-opt4';
    protected static $defaultDescription = 'Создание excel прайс-листа ОПТ4 для всех складов';
