...
class CreatePriceOpt5MskCommand extends Command
{
    protected static $defaultName = 'app:create-price-opt5-msk';
    protected static $defaultDescription = 'Создание excel прайс-листа ОПТ5 для МСК';
