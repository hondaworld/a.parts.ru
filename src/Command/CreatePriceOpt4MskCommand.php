...
class CreatePriceOpt4MskCommand extends Command
{
    protected static $defaultName = 'app:create-price-opt4-msk';
    protected static $defaultDescription = 'Создание excel прайс-листа ОПТ4 для МСК';
