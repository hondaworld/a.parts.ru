...
{
    protected static $defaultName = 'app:sales-per-day';
    protected static $defaultDescription = 'Продажи за предыдущий день';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            $text = $this->twig->render('app/orders/sales/table.html.twig', ['dateText' => $date->format('d.m.Y'), 'sales' => $sales, 'zapCards' => $zapCards]);
...
//        $email_send = 'info@hondaworld.ru';
        $this->emailSender->sendEmail($email_send, 'Статистика продаж за ' . $date->format('d.m.Y'), $text);
