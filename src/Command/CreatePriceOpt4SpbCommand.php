...
class CreatePriceOpt4SpbCommand extends Command
{
    protected static $defaultName = 'app:create-price-opt4-spb';
    protected static $defaultDescription = 'Создание excel прайс-листа ОПТ4 для СПБ';
