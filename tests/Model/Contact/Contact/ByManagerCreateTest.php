...
class ByManagerCreateTest extends TestCase
{
    public function testCreate(): void
    {
        ...
        $contact = new Contact($manager, $town, $address, '+79104651911', '+79104555555', '+7948484848', 'https://www.ru', 'email@domen.ru', 'Описание', false, true);

        $this->assertEquals($manager, $contact->getManager());
    ...
    public function testCreateNull(): void
    {
        ...
        $address = new Address('123456', 'Плещеева', '8', '1', '50');
        $manager = $this->createMock(Manager::class);
        $contact = new Contact($manager, $town, $address, null, null, null, null, null, null, false, true);
